...
function main() {
    ...
    const opcode = '0001' + '0'.repeat(7);

    const o = ``.split('\n').map(a => convert64BitBinaryToFixedHex(reverseStringOneLiner(a))).join(' ');
    console.log('OPCODE / LOCATION: ', parseInt(opcode, 2).toString(16).padStart(4, '0'));
    console.log('Image:', o);
}
main();